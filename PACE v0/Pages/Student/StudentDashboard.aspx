    ...
    <form id="frmDashboard" runat="server">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <%-- Dynamic class list from SchoolClass.GetClassesByStudent() --%>
        ...
        <div class="main">
            <header class="topbar">
                <div class="breadcrumb">
                    <span>PACE</span>&nbsp;&rsaquo;&nbsp;<span class="current">My Dashboard</span>
                </div>
            </header>
            ...
            <div class="hero">
                ...
                <div class="hero-sub">
                    Welcome back,
                    <asp:Label ID="lblHeroName" runat="server" />. You have
                    ...
                    <div class="card table-card">
                        <div class="card-header">
                            <div class="card-header-icon" style="background: #e8f0fa;">
                                <i class="ti ti-checklist" style="color: #3a5a8c; font-size: 17px;"></i>
                            </div>
                        ...
                        <%-- Dynamic task table from HomeworkTasks JOIN --%>
                        <asp:Repeater ID="rptTasks" runat="server">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn-view" href="../Student/TaskDetail.aspx?TaskID=<%# Eval("TaskID") %>">
