...
<body>
    <form id="frmTaskDetail" runat="server">
        ...
        <div class="main">
            ...
            <div class="hero">
                <div class="hero-title">Task Detail</div>
                <div class="hero-sub">Full details for this homework task.</div>
            </div>
            ...
            <div class="content">
                    ...
                    <div class="card">
                        <div class="detail-header">
                            ...
                            <div class="detail-meta">
                                ...
                                <span class="meta-pill"><i class="ti ti-book"></i>
                                    <asp:Label ID="lblSubject" runat="server" /></span>
                                <span class="meta-pill"><i class="ti ti-school"></i>
                ...
                <asp:Panel ID="pnlNotFound" runat="server" Visible="false">
                    <div class="card">
                        <div class="not-found">
                            Task not found or you do not have access to it.<br />
                            <br />
